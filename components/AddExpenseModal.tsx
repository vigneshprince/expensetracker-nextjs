...
export default function AddExpenseModal({ isOpen, onClose, categories, expenseDefs, editingExpense, initialData, onDelete, onSuccess }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      {/* Image Search Modal - Moved outside to prevent clipping/transform issues */}
      {showImageSearch && (
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl flex flex-col max-h-[90dvh] overflow-hidden animate-in fade-in zoom-in duration-200 border border-gray-100">
