...
import { format, eachDayOfInterval, isSameDay, isSameMonth, startOfMonth, parseISO, isSameYear } from 'date-fns';
...
export default function AnalyticsDashboard({ isOpen, onClose, expenses, dateRange, setDateRange, filterMode, setFilterMode }: Props) {
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar
                    ...
                    onClick={(data: any) => {
                      // When clicking Bar, 'data' is usually the single entry object + event info
                      // We can also use "activePayload" from the chart state if we wanted, 
                      // but standard 'active' behavior on Bar click gives us the payload in 'data' or 'data.payload' depending on version.
                      // Safest in Recharts is often data.payload if data wraps it, or data itself.
                      // Let's log if needed, but usually 'data' *is* the payload or contains it.
                      // Creating a robust handler:
