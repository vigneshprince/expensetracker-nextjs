    ...
    <div className="flex flex-wrap items-center gap-2 justify-center sm:justify-start">
      ...
      <div className="flex items-center gap-1 sm:gap-2 bg-gray-50 border border-gray-200 rounded-lg p-1 flex-shrink-0">
        {filterMode === 'single' ? (
          <input
            type="month"
            className="bg-transparent text-gray-900 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm font-medium focus:ring-2 focus:ring-gray-900 outline-none cursor-pointer min-w-[9.5rem] sm:min-w-0"
